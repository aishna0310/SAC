...
# 3.  save CSVs
# ---------------------------------------------------------------------------
mean_mat.to_csv("claude_MPI_means.csv", sep='\t', index_label='')
var_mat .to_csv("claude_MPI_vars.csv",  sep='\t', index_label='')

print("\nSaved:")
print("  • claude_MPI_means.csv   (16×16 means)")
print("  • claude_MPI_vars.csv    (16×16 variances)")
