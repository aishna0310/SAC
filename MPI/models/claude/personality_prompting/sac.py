...
def build_prompt(trait_const, trait, question, intensity_question, intensity_answers, intensity_scale):
    ...
    of {trait_const}
    IMPORTANT TO FOLLOW: Do not explain your answer and always exclusively give me the answer in the format: <number> 
...
all_traits = [
    ...
    "DUTIFULNESS", "EMOTIONAL STABILITY", "FRIENDLINESS", 
    "GREGARIOUSNESS",
