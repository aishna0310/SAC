...
def build_prompt(trait_const, trait, question, intensity_question, intensity_answers, intensity_scale):
    ...
    and relationship with the other traits. 
...
# grok_stats = process_results_for_model("grok", get_response_grok)

# # Output results for grok
# print("\ngrok Results:")
# for trait, stats in grok_stats.items():
...
for trait_const in all_traits:
    for intensity in intensities:
        ...
        # Run the process
        grok_stats = process_results_for_model("grok", get_response_grok, trait_const, intensity)
