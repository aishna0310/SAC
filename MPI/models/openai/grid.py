...
# neutral = pd.read_csv("openai_sac_neutral.csv", index_col="Trait")["Mean"]  # Series

# # ---------------------------------------------------------------------------
# # 1.  Load & clean the three intensity matrices
# # ---------------------------------------------------------------------------
# files = {
#     1: "ECAI-Results - openai_intensity_1.csv",          # intensity 1   (neutral-subtracted)
#     3: "ECAI-Results - openai_intensity_3.csv",  # intensity 3
#     5: "ECAI-Results - openai_intensity_5.csv"   # intensity 5
# }
...
# df1, df3, df5 = dfs[1], dfs[3], dfs[5]
# traits        = df1.index.tolist()                              # 16 traits
...
#         if col != target:                         # skip label on the bold line
#             texts.append(ax.text(5.15, y[-1], col,
#                                  fontsize=6, weight = 'bold',va='center'))
...
#              y=0.92, fontsize=14)
# fig.text(0.5, 0.04, "Intensity level", ha='center')
# fig.text(0.04, 0.5, "Δ score", va='center', rotation='vertical')
...
# # --- 0. read neutral table ------------------------------------------------
# neutral = pd.read_csv("claude_sac_neutral.csv", index_col="Trait")["Mean"]  # Series
# # ---------------------------------------------------------------------------
# # 1.  Load & clean the three intensity matrices
# # ---------------------------------------------------------------------------
# files = {
#     1: "claude_sac_intensity_1.csv",          # intensity 1   (neutral-subtracted)
#     3: "claude_sac_intensity_3.csv",  # intensity 3
#     5: "claude_sac_intensity_5.csv"   # intensity 5
# }
    ...
    for col in plot_cols:
        ...
        if col != target: 
            if col == "EMOTIONAL STABILITY":
                texts.append(ax.text(5.15, y[-1] + 0.15, "EMOTIONAL", fontsize=9, va='center', ha='center'))  # Adjust y position
                texts.append(ax.text(5.15, y[-1] + 0.1, "STABILITY", fontsize=9, va='center', ha='center'))  # Adjust y position
            else:
