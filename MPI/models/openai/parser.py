...
# 3.  save CSVs
# ---------------------------------------------------------------------------
mean_mat.to_csv("openai_MPI_means.csv", sep='\t', index_label='')
var_mat .to_csv("openai_MPI_vars.csv",  sep='\t', index_label='')

print("\nSaved:")
print("  • openai_MPI_means.csv   (16×16 means)")
print("  • openai_MPI_vars.csv    (16×16 variances)")
