...
# openai_stats = process_results_for_model("OpenAI", get_response_openai)

# # Output results for OpenAI
# print("\nOpenAI Results:")
# for trait, stats in openai_stats.items():
...
for trait_const in all_traits:
    for intensity in intensities:
        ...
        # Run the process
        openai_stats = process_results_for_model("OpenAI", get_response_openai, trait_const, intensity)
