...
for index, row in traits_df.iterrows():
    ...
    for i, intensity_row in intensity_df.iterrows():
        ...
        try:
            ...
            print(f"deepseek Responses: {deepseek_responses}")  # Debugging print
            
            if len(deepseek_responses) < 2:
                raise IndexError("Expected at least two lines in deepseek response.")
